...
<div class="wrapper row3">
  <main class="container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
      <h1> Situatia platii taxelor </h1>

    <table class='table table-hover text-center'>
        <th><td><b>Nume cursant</b></td><td><b>CNP cursant</b></td><td><b>Achitat</b></td></th>
        ...
        <?php
            ...
            try {
                ...
                $query = $connection->prepare("SELECT Nume, CNP, Platit FROM cursanti;");
                $query->execute();
                ...
                foreach ($query->fetchAll() as $row) {
                    ...
                    $platit = $row["Platit"];
                    if ($platit == '1') {
                        $platit = "Achitat integral";
                    }
                    else {
                        $platit = "Neachitat";
                    }
                    echo "<tr><td></td><td>".$nume."</td><td>".$cnp."</td><td>".$platit."</td></tr>";
                }    
            }
...
<div class="wrapper row5">
  <footer id="footer" class="clear"> 
    ...
    <div class="one_quarter">
      ...
      <ul class="nospace linklist">
        <li><a href="taxe.php">Mergi sus</a></li>
        <li><a href="prezentare.html">Specializari</a></li>
        <li><a href="inscriere.php">Inscriere</a></li>
      </ul>
    </div>
